...
- `src/routes/_authenticated/admin.leads.tsx` (list + detail panel) following the existing `admin.sales.tsx` patterns; nav entry added next to the other admin items.
