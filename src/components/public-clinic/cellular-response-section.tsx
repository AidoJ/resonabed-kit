...
export function CellularResponseSection() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => setStep(n => (n + 1) % STEPS.length), 5833);
    ...
    <section id="cellular-response" className="cr-section" ref={root} aria-label="The cellular response">
      ...
      <div className="cr-wrap">
        ...
        <header className="cr-header">
          <h2>How cells sense<br /><span>mechanical movement.</span></h2>
          <p className="cr-intro">Explore how cells turn physical movement into internal signals.</p>
        </header>
        ...
        <footer className="cr-footer"><span>Illustration of cellular mechanisms; responses depend on the cell type and stimulation conditions.</span><span>Not to scale · 35-second tour</span></footer>
