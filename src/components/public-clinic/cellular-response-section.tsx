...
.cr-modes{display:flex;gap:8px;margin:0 0 22px;flex-wrap:wrap}.cr-modes button{padding:12px 19px;border:1px solid #ded5e6;border-radius:30px;background:transparent;color:#70627b;font-size:13px}.cr-modes button[aria-pressed="true"]{background:#70508c;color:white;border-color:#70508c}.cr-section [hidden]{display:none!important}
