  ...
  return (
    <div className="space-y-6">
      ...
      <label className="flex items-start gap-3 rounded-md border p-4 text-sm">
        ...
        />
        <span>
          The client has given informed consent for this vibroacoustic wellbeing session and
          understands it is intended for relaxation and general wellbeing, not medical treatment.
        </span>
      </label>
    </div>
  );
