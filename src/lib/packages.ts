...
export const PACKAGES: Record<PackageKey, PackageDef> = {
  essentials: {
    ...
    listCents: 139900,
    balanceCents: 129900,
    planListCents: 149900,
    plan: { depositBalanceCents: 39900, monthlyCents: 10000, months: 10 },
  ...
  home: {
    ...
    listCents: 169900,
    balanceCents: 159900,
    planListCents: 179900,
    plan: { depositBalanceCents: 59900, monthlyCents: 11000, months: 10 },
    shippingScope: "home",
    shipsTable: true,
    personalOnly: true,
    description:
