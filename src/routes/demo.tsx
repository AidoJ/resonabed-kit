    ...
    <div className="demo-page">
      ...
      <header className="demo-header">
        ...
        <nav aria-label="Demo page navigation">
          <Link className="demo-nav-link demo-home-link" to="/">Home</Link>
      ...
      <footer className="demo-wrap demo-footer"><Link className="demo-wordmark" to="/" aria-label="ResonaBed home"><img src={logo.url} alt="Resonabed. Feel. Rest. Restore." /></Link><p>A new therapy. A new opportunity for your practice.</p><span className="demo-footer-links"><Link to="/">Home</Link><a href="https://rejuvenators.com/privacypolicy/" target="_blank" rel="noopener noreferrer">Privacy policy</a></span><span>© {new Date().getFullYear()} ResonaBed</span></footer>
